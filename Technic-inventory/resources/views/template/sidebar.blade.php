<div class="flex h-full max-w-xs flex-col rounded-xl bg-white bg-clip-border p-0 text-gray-700 shadow-xl shadow-blue-gray-900/5">
  <div class="px-4 ">
    <span class="ml-4"><img src="{{ asset('storage/images/b7.png') }}" alt="Image"></span>
  </div>
